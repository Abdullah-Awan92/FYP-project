    ...
    <div className="w-64 h-screen fixed top-0 left-0 bg-[#002855] text-white flex flex-col justify-between py-10">
      <div>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link to="/student-management" className={linkClass('/student-management')}>
            <i className="fa-solid fa-user mr-3"></i>
            Student Management
          </Link>
          <Link to="/manage-exams" className={linkClass('/manage-exams')}>
            <i className="fa-solid fa-clipboard-check mr-3"></i>
            Manage Exams
          </Link>
          <Link to="/review-cheating" className={linkClass('/review-cheating')}>
